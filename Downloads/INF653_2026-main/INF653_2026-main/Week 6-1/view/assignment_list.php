        ...
        <?php foreach ($assignments as $assignment) : ?>
            <div class="assignment-item">
                ...
                <div style="display: flex; gap: 10px;">
                    <a href="update_assignment.php?assignment_id=<?= $assignment['ID'] ?>" style="padding: 5px 10px; background-color: #007bff; color: white; text-decoration: none; border-radius: 3px;">Edit</a>
