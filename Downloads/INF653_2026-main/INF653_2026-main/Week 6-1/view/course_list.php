    ...
    <section id="list" class="course-container">
        ...
        <?php foreach ($courses as $course) : ?>
            <div class="list__row">
                ...
                <div class="list__removed" style="display: flex; gap: 10px; align-items: center;">
                    <a href="update_course.php?course_id=<?= $course['courseID'] ?>" style="padding: 5px 10px; background-color: #007bff; color: white; text-decoration: none; border-radius: 3px;">Edit</a>
